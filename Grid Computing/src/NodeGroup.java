...
public class NodeGroup implements java.io.Serializable
{
	...
	NodeProfile[] nodeprofile = new NodeProfile[1000];
	String RM_url =null;
	int RM_id = -1;
	
	public NodeGroup(String RMurl,int RM_id)
	{
		this.RM_url = RMurl; 
		this.RM_id = RM_id;
	}
	
	public NodeGroup(ArrayList<String> node_url,ArrayList<Integer> node_id,ArrayList<Integer> node_status,ArrayList<Job> job,String RM_url,int RM_id)
	{
	...
	public void addByID(int id, NodeProfile np)
	{
		nodeprofile[id] = np; 
	}
	
	public NodeProfile getByID(int id)
	{
